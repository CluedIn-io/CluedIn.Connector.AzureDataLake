...
public class AmazonS3ConfigurationConstants : StorageConfigurationConstants, IAmazonS3ConfigurationConstants
{
    ...
    public AmazonS3ConfigurationConstants(ApplicationContext applicationContext) : base(S3ProviderId,
