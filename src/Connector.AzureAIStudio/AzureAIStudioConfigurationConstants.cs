...
public class AzureAIStudioConfigurationConstants : StorageConfigurationConstants, IAzureAIStudioConfigurationConstants
{
    ...
    public AzureAIStudioConfigurationConstants(ApplicationContext applicationContext) : base(DataLakeProviderId,
