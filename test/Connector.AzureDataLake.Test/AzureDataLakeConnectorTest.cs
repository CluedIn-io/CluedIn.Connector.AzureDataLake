...
namespace Connector.AzureDataLakeTests
{
    public class AzureDataLakeConnectorTest
    {
        ...
        //Test your Data Lake account here - Uncomment to use
        //[Fact]
        ...
        [Theory]
        [InlineData("chad")]
        [InlineData("chad-filesys")]
        [InlineData("ch123")]
        public void ValidateFileSystemName_Test(string filesysName)
        {
            connector.ValidateFileSystemName(filesysName);
        }
        ...
        [InlineData("filesys-")]
        [InlineData("123-")]
        public void ValidateFileSystemName_Test_Exeption(string filesysName)
        {
            Should.Throw<ArgumentException>(() => connector.ValidateFileSystemName(filesysName));
